...
class PaymentOutboxEventStateServiceTests {
    ...
    void setUp() {
        ...
        states = new PaymentOutboxEventStateService(
                repository,
                properties,
    ...
    @Test
    void markPublishedSetsPublishedTimestampAndClearsClaim() {
        UUID id = UUID.randomUUID();
        UUID claimToken = UUID.randomUUID();
        PaymentOutboxEvent event = event(id, claimToken);
    ...
    private PaymentOutboxEvent event(UUID id, UUID claimToken) {
