...
public class PaymentOutboxEventStateService {
    ...
    public void markPublished(UUID id, UUID claimToken) {
        PaymentOutboxEvent event = repository.findById(id).orElse(null);
    ...
    private boolean claimMatches(PaymentOutboxEvent event, UUID claimToken) {
