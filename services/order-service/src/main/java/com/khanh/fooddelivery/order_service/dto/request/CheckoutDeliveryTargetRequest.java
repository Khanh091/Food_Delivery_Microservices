...
public record CheckoutDeliveryTargetRequest(
    ...
    public static CheckoutDeliveryTargetRequest savedAddress(UUID addressId) {
        return new CheckoutDeliveryTargetRequest(
                "SAVED_ADDRESS",
                addressId,
                null
        );
    ...
    public boolean isValid() {
        return "SAVED_ADDRESS".equals(type)
                ? addressId != null && temporaryLocationId == null
                : "TEMPORARY_LOCATION".equals(type)
                && addressId == null
