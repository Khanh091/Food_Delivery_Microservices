...
public class Order {
    ...
    @Column(nullable = false) private String branchName;
    @Enumerated(EnumType.STRING) @Column(nullable = false) private OrderStatus status;
    @Column(nullable = false) private String currency;
    @Column(nullable = false) private BigDecimal itemsSubtotal;
    ...
    @Column(nullable = false) private String addressDisplayLabel;
    @Column(nullable = false) private String recipientName;
    @Column(nullable = false) private String recipientPhone;
    @Column(nullable = false, length = 1000) private String addressLine;
    private String ward; private String district; private String city;
    ...
    @OrderBy("sortOrder ASC") private List<OrderItem> items = new ArrayList<>();
}
