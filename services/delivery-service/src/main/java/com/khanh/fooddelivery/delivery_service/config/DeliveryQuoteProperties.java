...
public class DeliveryQuoteProperties {
    ...
    public long getIncludedDistanceMeters() {
        return includedDistanceMeters;
    }

    public void setIncludedDistanceMeters(long includedDistanceMeters) {
        this.includedDistanceMeters = includedDistanceMeters;
    }
    ...
    public long getMaximumServiceDistanceMeters() {
        return maximumServiceDistanceMeters;
    }

    public void setMaximumServiceDistanceMeters(
            long maximumServiceDistanceMeters
    ) {
        this.maximumServiceDistanceMeters = maximumServiceDistanceMeters;
    }

    public String getPricingPolicyVersion() {
        return pricingPolicyVersion;
    }

    public void setPricingPolicyVersion(String pricingPolicyVersion) {
